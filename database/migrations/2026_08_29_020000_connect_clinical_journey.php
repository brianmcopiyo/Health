...
return new class extends Migration
{
    public function up(): void
    {
        Schema::table('patients', function (Blueprint $table) {
            ...
            $table->foreignUuid('source_patient_id')->nullable()->after('hospital_id')->constrained('patients')->nullOnDelete();
            $table->text('notes')->nullable();
        });

        Schema::table('users', function (Blueprint $table) {
            $table->foreignUuid('department_id')->nullable()->after('job_title')->constrained()->nullOnDelete();
        ...
        Schema::create('patient_allergies', function (Blueprint $table) {
            ...
            $table->foreignUuid('noted_by')->nullable()->constrained('users')->nullOnDelete();
        ...
        Schema::table('encounters', function (Blueprint $table) {
            $table->foreignUuid('parent_encounter_id')->nullable()->after('facility_id')->constrained('encounters')->nullOnDelete();
            $table->foreignUuid('referral_id')->nullable()->after('parent_encounter_id')->constrained('referrals')->nullOnDelete();
            $table->foreignUuid('ambulance_trip_id')->nullable()->after('referral_id')->constrained('ambulance_trips')->nullOnDelete();
        ...
        Schema::table('service_orders', function (Blueprint $table) {
            $table->foreignUuid('service_id')->nullable()->after('encounter_id')->constrained('clinical_services')->nullOnDelete();
        ...
        Schema::create('prescriptions', function (Blueprint $table) {
            ...
            $table->foreignUuid('patient_id')->constrained()->cascadeOnDelete();
            $table->foreignUuid('encounter_id')->constrained()->cascadeOnDelete();
            $table->foreignUuid('prescribed_by')->nullable()->constrained('users')->nullOnDelete();
        ...
        Schema::create('prescription_items', function (Blueprint $table) {
            ...
            $table->foreignUuid('medication_id')->constrained()->restrictOnDelete();
            $table->string('dose');
        ...
        Schema::table('invoice_items', function (Blueprint $table) {
            ...
            $table->foreignUuid('service_id')->nullable()->after('source_id')->constrained('clinical_services')->nullOnDelete();
        });
        ...
        Schema::table('referrals', function (Blueprint $table) {
            $table->foreignUuid('encounter_id')->nullable()->after('patient_id')->constrained()->nullOnDelete();
            $table->foreignUuid('referring_clinician_id')->nullable()->after('encounter_id')->constrained('users')->nullOnDelete();
            $table->foreignUuid('required_service_id')->nullable()->after('required_facility_type_id')->constrained('clinical_services')->nullOnDelete();
            $table->foreignUuid('receiving_patient_id')->nullable()->after('patient_id')->constrained('patients')->nullOnDelete();
            $table->foreignUuid('receiving_encounter_id')->nullable()->after('encounter_id')->constrained('encounters')->nullOnDelete();
            $table->foreignUuid('counter_referral_id')->nullable()->constrained('referrals')->nullOnDelete();
        });
        ...
        Schema::table('assistance_requests', function (Blueprint $table) {
            ...
            $table->foreignUuid('encounter_id')->nullable()->after('patient_id')->constrained()->nullOnDelete();
            $table->foreignUuid('facility_type_id')->nullable()->after('encounter_id')->constrained()->nullOnDelete();
            $table->foreignUuid('facility_id')->nullable()->after('facility_type_id')->constrained()->nullOnDelete();
            $table->unsignedInteger('quantity')->default(1)->after('type');
        });

        Schema::table('ambulance_trips', function (Blueprint $table) {
            $table->foreignUuid('patient_id')->nullable()->after('ambulance_id')->constrained()->nullOnDelete();
            $table->foreignUuid('encounter_id')->nullable()->after('patient_id')->constrained()->nullOnDelete();
            $table->foreignUuid('referral_id')->nullable()->after('encounter_id')->constrained()->nullOnDelete();
            $table->string('pickup_location')->nullable()->after('origin');
            $table->foreignUuid('destination_facility_id')->nullable()->after('destination_hospital_id')->constrained('facilities')->nullOnDelete();
            $table->foreignUuid('receiving_encounter_id')->nullable()->constrained('encounters')->nullOnDelete();
            $table->text('handover_notes')->nullable();
            $table->timestamp('handover_at')->nullable();
        });

        Schema::table('bed_assignments', function (Blueprint $table) {
            $table->foreignUuid('ward_id')->nullable()->after('facility_id')->constrained('facilities')->nullOnDelete();
            $table->foreignUuid('nurse_id')->nullable()->after('assigned_by')->constrained('users')->nullOnDelete();
        });
    }
